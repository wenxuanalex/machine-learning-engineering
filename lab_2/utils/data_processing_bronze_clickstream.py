...
def process_bronze_clickstream(snapshot_date_str, bronze_clickstream_directory, spark):
    """
    Ingest raw clickstream features for a single snapshot date into the Bronze layer.
    ...
    Args:
        ...
        bronze_clickstream_directory: Path to the Bronze clickstream directory.
    ...
    # Note: the file in the data directory is named 'feature_clickstream.csv'
    ...
    partition_name = "bronze_clickstream_" + snapshot_date_str.replace("-", "_")
